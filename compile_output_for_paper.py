...
individual_file_names = [
    ...
    "lineplot_gepu",
    "scatter_global_gdpvol_epu_privdebtp75",
    "scatter_global_gdpvol_wui_privdebtp75",
    "scatter_global_gdpvol_uct_privdebtp75",
    "scatter_global_gdpvol_epu_govdebtp75",
    "scatter_global_gdpvol_wui_govdebtp75",
    "scatter_global_gdpvol_uct_govdebtp75",
