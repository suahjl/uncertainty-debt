...
def do_everything(
    ...
    if threshold_option == "placebo":
        # Create random states for threshold variable
    ...
    for shock in shocks_to_plot:
        for response in tqdm(cols_endog_micro):
            ...
            fig.write_image(
                path_output
                + "micro_quarterly_placebo_panelthresholdlp_"
                + file_suffixes
                + "modwith_"
...
threshold_option = "placebo"  # "pols_minaicc"  "manual"  p75
